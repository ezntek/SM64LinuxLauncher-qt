...
class Ui_RecheckConfigurationDialog(object):
    def setupUi(self, RecheckConfigurationDialog):
        ...
        self.l_repo_display = QtWidgets.QLabel(RecheckConfigurationDialog)
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.l_repo_display.setFont(font)
        ...
        self.combobox_jobs.addItem("")
        self.combobox_jobs.addItem("")
        self.gridLayout.addWidget(self.combobox_jobs, 5, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.line_edit_build_flags, 6, 1, 1, 4)
        ...
        self.combobox_romregion.addItem("")
        self.combobox_romregion.addItem("")
        self.gridLayout.addWidget(self.combobox_romregion, 3, 1, 1, 4)
        ...
        self.b_cancel = QtWidgets.QPushButton(RecheckConfigurationDialog)
        self.b_cancel.setObjectName("b_cancel")
        self.gridLayout.addWidget(self.b_cancel, 11, 2, 1, 1)
        self.b_build = QtWidgets.QPushButton(RecheckConfigurationDialog)
        self.b_build.setObjectName("b_build")
        self.gridLayout.addWidget(self.b_build, 11, 3, 1, 2)
        self.clear_model_pack = QtWidgets.QPushButton(RecheckConfigurationDialog)
        self.clear_model_pack.setObjectName("clear_model_pack")
        self.gridLayout.addWidget(self.clear_model_pack, 9, 3, 1, 2)
        self.clear_texture_pack = QtWidgets.QPushButton(RecheckConfigurationDialog)
        self.clear_texture_pack.setObjectName("clear_texture_pack")
        self.gridLayout.addWidget(self.clear_texture_pack, 7, 3, 1, 2)
        self.b_baserom_path = QtWidgets.QPushButton(RecheckConfigurationDialog)
        self.b_baserom_path.setObjectName("b_baserom_path")
        self.gridLayout.addWidget(self.b_baserom_path, 2, 3, 1, 2)
        ...
        self.clear_texture_pack.clicked.connect(self.line_edit_texture_pack.clear) # type: ignore
        self.clear_model_pack.clicked.connect(self.line_edit_model_pack.clear) # type: ignore
    ...
    def retranslateUi(self, RecheckConfigurationDialog):
        ...
        self.l_repo_display.setText(_translate("RecheckConfigurationDialog", "Placeholder"))
        ...
        self.b_cancel.setText(_translate("RecheckConfigurationDialog", "Cancel"))
        self.b_build.setText(_translate("RecheckConfigurationDialog", "Build"))
        self.clear_model_pack.setText(_translate("RecheckConfigurationDialog", "Clear"))
        self.clear_texture_pack.setText(_translate("RecheckConfigurationDialog", "Clear"))
